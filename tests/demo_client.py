...
DB_PATH = os.path.join(PROJECT_ROOT, "legacy_store.db")
...
def main():
    ...
    create_result = validator.validate_and_execute("create_categories", {
        "name": test_name,
        "description": "Created by demo client",
        "created_at": "2024-01-01T00:00:00"
    })
    new_id = create_result[0].get('last_insert_id')
    print(f"  [OK] Created row with ID: {new_id}")
...
""")
    ...
    if new_id:
        validator.validate_and_execute("delete_categories", {"id": new_id})
